 ...
 */
package SOURCES.MoteurRecherche_Tresorerie;
 ...
 * @author user
 */
public abstract class MoteurRechercheTres {
    ...
    public MoteurRechercheTres(Icones icones, JS2bTextField champTexte, EcouteurUpdateClose ecouteurUpdateClose) {
        ...
        processus = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Logger.getLogger(MoteurRechercheTres.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
