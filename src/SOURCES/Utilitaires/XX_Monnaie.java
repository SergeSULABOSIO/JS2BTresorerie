 ...
 * @author user
 */
public class XX_Monnaie implements InterfaceMonnaie{
    public int id;
    ...
    public XX_Monnaie(int id, int idEntreprise, int idUtilisateur, int idExercice, String nom, String code, int nature, double tauxMonnaieLocale, long signature, int beta) {
        this.id = id;
