...
public class XX_Entreprise implements InterfaceEntreprise{
    ...
    public XX_Entreprise(int id, String nom, String adresse, String telephone, String email, String siteWeb, String banque, String intituleCompte, String numeroCompte, String IBAN, String codeSwift, String logo, String rccm, String idNat, String numeroImpot) {
        this.id = id;
        this.nom = nom;
