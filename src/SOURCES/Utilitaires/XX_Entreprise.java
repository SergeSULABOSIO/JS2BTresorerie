 ...
 * @author HP Pavilion
 */
public class XX_Entreprise implements InterfaceEntreprise{
    public int id;
    public String nom;
    ...
    public XX_Entreprise() {
    }

    public XX_Entreprise(int id, String nom, String adresse, String telephone, String email, String siteWeb, String logo, String rccm, String idnat, String numeroImpot, String banque, String intituleCompte, String numeroCompte, String iban, String codeSwift) {
        this.id = id;
        this.nom = nom;
