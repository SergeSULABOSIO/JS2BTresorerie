 ...
 * @author user
 */
public class XX_Encaissement implements InterfaceEncaissement{
    public int id;
    ...
    public XX_Encaissement(int id, int destination, String reference, Date date, double montant, int idMonnaie, String monnaie, String effectuePar, String motif, int idRevenu, String revenu, int beta) {
        this.id = id;
