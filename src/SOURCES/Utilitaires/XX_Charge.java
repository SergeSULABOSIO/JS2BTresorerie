 ...
 * @author HP Pavilion
 */
public class XX_Charge implements InterfaceCharge{
    ...
    public XX_Charge(int id, int idEntreprise, int idUtilisateur, int idExercice, String nom, double limiteAnnuelle, int idMonnaie, long signatureMonnaie, String monnaie, int beta) {
        this.id = id;
