 ...
 * @author user
 */
public class XX_Revenu implements InterfaceRevenu{
    public int id;
    ...
    public XX_Revenu(int id, int idEntreprise, int idUtilisateur, int idExercice, int idMonnaie, long signatureMonnaie, String nom, String monnaie, double volumeAnnuel, int beta) {
        this.id = id;
