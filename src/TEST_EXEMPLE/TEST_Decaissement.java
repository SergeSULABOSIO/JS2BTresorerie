 ...
 * @author user
 */
public class TEST_Decaissement implements InterfaceDecaissement{
    public int id;
    ...
    public TEST_Decaissement(int id, int source, String reference, Date date, double montant, int idMonnaie, String monnaie, String beneficiaire, String motif, int idCharge, String charge, int beta) {
        this.id = id;
        this.source = source;
